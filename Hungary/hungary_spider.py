...
class AllSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        # v2
            'http://www.greenpeace.org/hungary/hu/sajtokozpont/zoldterulet-kozvelemenykutatas-201708/':('Press Release','Természet & Környezet','Zöldterület','Egészség','','article','Migrate'),
            'http://www.greenpeace.org/hungary/hu/sajtokozpont/Zold-civil-szervezetek-udvozlik-a-szabadkereskedelmi-egyezmenyekkel-kapcsolatos-orszaggylesi-hatarozatot/':('Press Release','Ember & Társadalom','Fogyasztás','','','article','Migrate'),
            'http://www.greenpeace.org/hungary/hu/sajtokozpont/Videoval-es-kozjegyzvel-bizonyitja-a-Greenpeace-hogy-a-Sparban-vasarolta-a-paprikat/':('Press Release','Természet & Környezet','Szennyezés','Egészség','Fogyasztás','article','Migrate'),
            'http://www.greenpeace.org/hungary/hu/sajtokozpont/Veszelyes-vegyszereket-talalt-markas-turaruhakban-a-Greenpeace/':('Press Release','Természet & Környezet','Szennyezés','Fogyasztás','','article','Migrate'),
            'http://www.greenpeace.org/hungary/hu/sajtokozpont/Veszelyes-vegyi-anyagok-a-divatban--nemcsak-a-Zaranak-vannak-mocskos-titkai/':('Press Release','Természet & Környezet','Szennyezés','Egészség','Fogyasztás','article','Migrate'),
            'http://www.greenpeace.org/hungary/hu/sajtokozpont/Veszelybe-kerulhet-hazank-nuklearis-biztonsaga/':('Press Release','Klíma & Energia','Atomenergia','','','article','Migrate'),
            #'http://www.greenpeace.org/hungary/hu/sajtokozpont/Versenyfutas-az-idvel-a-mehekert/':('Press Release','Természet & Környezet','Méhek','Szennyezés','Élővilág','article','Migrate'),
            ...
            'http://www.greenpeace.org/hungary/hu/sajtokozpont/Ujabb-mehgyilkos-mezgazdasagi-vegyszer-hasznalatat-korlatozza-az-EU/':('Press Release','Természet & Környezet','Méhek','Szennyezés','Élővilág','article','Migrate'),
            'http://www.greenpeace.org/hungary/hu/sajtokozpont/Ujabb-kerdjelek-Magyarorszag-nuklearis-biztonsaga-korul/':('Press Release','Klíma & Energia','Atomenergia','','','article','Migrate'),

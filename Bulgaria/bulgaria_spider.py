...
class AllSpider(scrapy.Spider):
    ...
    custom_settings = {
        'ROBOTSTXT_OBEY': 0,
        'FEED_URI': 'gpbg_staging_v1_2.xml',
        'FEED_FORMAT': 'xml',
    ...
    def start_requests(self):
        ...
        #'http://www.greenpeace.org/bulgaria/bg/campaigns/anti-yadrena-kampaniya/sedmi-blok-aec-kozlodui/':('Publication','Енергия','','АЕЦ','','','article','Migrate'),
        ...
        #'http://www.greenpeace.org/bulgaria/bg/campaigns/climate_change/badeshte-bez-vuglishta/finansovi-mini/':('Publication','Енергия','','Въглища','','','article','Migrate'),
        #'http://www.greenpeace.org/bulgaria/bg/campaigns/climate_change/badeshte-bez-vuglishta/Coal-reports-in-English/financial-mines/':('Publication','Енергия','','Въглища','','','article','Migrate'),

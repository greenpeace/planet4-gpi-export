...
class AllSpider(scrapy.Spider):
    ...
    def start_requests(self):
        # v1
        start_urls = {
            'https://www.greenpeace.org/sweden/se/nyheter/blogg/ett-brev-frn-en-ubtsfrare-det-vi-fann-i-den-d/blog/61157/':('Bakgrund','HAV','','Havsreservat','','','news-list','Migrate'),
'https://www.greenpeace.org/sweden/se/nyheter/blogg/vi-har-ett-r-p-oss-att-skapa-vrldens-strsta-s/blog/60639/':('Bakgrund','HAV','','Havsreservat','Klimatförändringar','','news-list','Migrate'),
'https://www.greenpeace.org/sweden/se/nyheter/blogg/drfr-smakar-rkorna-ruttet-i-sommar/blog/46016/':('Bakgrund','HAV','','Fiske','','','news-list','Migrate'),
'https://www.greenpeace.org/sweden/se/nyheter/blogg/aktivisterna-har-gjort-oss-alla-en-tjnst/blog/48436/':('Bakgrund','KLIMAT','','Energi','PeoplePower','','news-list','Migrate'),
#'https://www.greenpeace.org/sweden/se/nyheter/nyheter/Oppet-Brev1/':('Bakgrund','LAND','','Skog','vårskog sveaskog','','news-list','Migrate'),
'https://www.greenpeace.org/sweden/se/nyheter/blogg/aarhuskarlshamn-aak-den-nordiska-palmoljejtte/blog/49727/':('Bakgrund','LAND','','Skog','','','news-list','Migrate'),
'https://www.greenpeace.org/sweden/se/nyheter/blogg/nu-avgiftar-gore-tex-och-du-fick-det-att-hnda/blog/58654/':('Bakgrund','MÄNNISKOR','','Konsumtion','PeoplePower','','news-list','Migrate'),
'https://www.greenpeace.org/sweden/se/nyheter/nyheter/fn-japanska-myndigheter-bryte/':('Nyhet','HAV','','Fiske','','','article','Migrate'),
'https://www.greenpeace.org/sweden/se/nyheter/nyheter/Darfor-Arktis-darfor-nu/':('Nyhet','HAV','','Havsreservat','Energi','','article','Migrate'),
'https://www.greenpeace.org/sweden/se/nyheter/nyheter/Over-ett-ton-svenskfiskade-rakor-dumpas-i-havet---varje-dag/':('Nyhet','HAV','','Fiske','','','article','Migrate'),
'https://www.greenpeace.org/sweden/se/nyheter/nyheter/elbolag/':('Nyhet','KLIMAT','','Energi','','','article','Migrate'),
'https://www.greenpeace.org/sweden/se/nyheter/nyheter/Ringhals---Sveriges-sakraste-karnkraftverk/':('Nyhet','LAND','','Kärnkraft','Energi','','article','Migrate'),
'https://www.greenpeace.org/sweden/se/nyheter/nyheter/Nya-riksdagen-har-begransad-koldioxidbudget/':('Nyhet','KLIMAT','','Klimatförändringar','','','article','Migrate'),
'https://www.greenpeace.org/sweden/se/nyheter/nyheter/Nike-lovar-att-avgifta-sin-tillverkning/':('Nyhet','MÄNNISKOR','','Konsumtion','','','article','Migrate'),
'https://www.greenpeace.org/sweden/se/press/pressmeddelanden/enad-klimatrorelse-samlad-mot-norsk-oljeborrning-i-arktis/Greenpeace-slapper-skogsapp/En-vinst-for-Antarktis/':('Pressmeddelande','HAV','','Havsreservat','Fiske','','article','Migrate'),
'https://www.greenpeace.org/sweden/se/press/pressmeddelanden/Greenpeace-teamar-upp-med-kanda-vattensportare-for-plastfria-hav/':('Pressmeddelande','HAV','','Plast','Konsumtion','','article','Migrate'),
'https://www.greenpeace.org/sweden/se/press/pressmeddelanden/EU-parlamentet-tar-historiskt-kliv-mot-plastfororeningar/':('Pressmeddelande','HAV','','Plast','','','article','Migrate'),
'https://www.greenpeace.org/sweden/se/press/pressmeddelanden/Valaffisherna-som-far-partiledarna-att-skammas/':('Pressmeddelande','KLIMAT','','Klimatlösningar','','','article','Migrate'),
'https://www.greenpeace.org/sweden/se/press/pressmeddelanden/enad-klimatrorelse-samlad-mot-norsk-oljeborrning-i-arktis/Greenpeace-slapper-skogsapp/':('Pressmeddelande','LAND','','Skog','Klimatförändringar','','article','Migrate'),
'https://www.greenpeace.org/sweden/se/press/pressmeddelanden/Lina-Burnelius-pa-Greenpeace-ar-en-av-33-hallbarhetstalanger-i-Sverige/':('Pressmeddelande','MÄNNISKOR','','PeoplePower','Skog','','article','Migrate'),
'https://www.greenpeace.org/sweden/se/rapporter-och-dokument/Staten-kapitalet-och-oljan/':('Rapport','KLIMAT','','Klimatförändringar','Energi','','article','Migrate'),
'https://www.greenpeace.org/sweden/se/rapporter-och-dokument/Driving-to-destruction/':('Rapport','KLIMAT','','Energi','','','article','Migrate'),
'https://www.greenpeace.org/sweden/se/rapporter-och-dokument/Brev-till-AP-fonderna/':('Rapport','KLIMAT','','Klimatförändringar','Energi','','article','Migrate'),
'https://www.greenpeace.org/sweden/se/nyheter/nyheter/Radda-mangfalden-av-liv-i-skogen/':('Rapport','LAND','','Skog','Klimatförändringar klimatlösning skyddaskogen','','article','Migrate'),
'https://www.greenpeace.org/sweden/se/rapporter-och-dokument/Swimming-in-Chemicals1/':('Rapport','MÄNNISKOR','','Konsumtion','','','article','Migrate'),
        }
    ...
    def filter_month_name(self, month_name):
        ...
        # Replace the Swedish month name with english month name.
        for se_month, en_month in month_se_en.iteritems():
            month_name = month_name.replace(se_month, en_month)

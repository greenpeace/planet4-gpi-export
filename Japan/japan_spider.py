...
class AllSpider(scrapy.Spider):
    ...
    def start_requests(self):
        # v1
        start_urls = {
            'http://www.greenpeace.org/japan/ja/info/recruit/finance200818/':('Story','グリーンピースについて','','#グリーンピースについて','','','article','Migrate'),
            'http://www.greenpeace.org/japan/ja/library/publication/nipponlife/':('Publication','サステナブルに生きる','','#原発','','','article','Migrate'),
            'http://www.greenpeace.org/japan/ja/library/publication/annual_report_2017/':('Publication','グリーンピースについて','','#グリーンピースについて','','','article','Migrate'),
            'http://www.greenpeace.org/japan/ja/news/blog/dblog/blog/60034/':('Story','つながる','','#平和と民主主義','','','news-list','Migrate'),
            'http://www.greenpeace.org/japan/ja/news/blog/dblog/blog/50791/':('Story','自然を守る','','#森林','','','news-list','Migrate'),
            'http://www.greenpeace.org/japan/ja/news/blog/staff/blog/61139/':('Story','自然を守る','','#海洋生態系','#船','','news-list','Migrate'),
            'http://www.greenpeace.org/japan/ja/news/blog/staff/blog/48887/':('Story','サステナブルに生きる','','#食と農業','','','news-list','Migrate'),
            'http://www.greenpeace.org/japan/ja/news/blog/staff/x-ngo/blog/60742/':('Story','つながる','','#ボランティア','#イベント','','news-list','Migrate'),
            'http://www.greenpeace.org/japan/ja/library/publication/20180123/':('Publication','サステナブルに生きる','','#原発','#自然エネルギー','','article','Migrate'),
            'http://www.greenpeace.org/japan/ja/library/publication/20180425/':('Publication','サステナブルに生きる','','#石炭','','','article','Migrate'),
            'http://www.greenpeace.org/japan/ja/library/publication/2013leaking_bp/':('Publication','サステナブルに生きる','','#原発','','','article','Migrate'),
            'http://www.greenpeace.org/japan/ja/news/blog/staff/blog/60006/':('Story','つながる','','#ボランティア','','','news-list','Migrate'),
            'http://www.greenpeace.org/japan/ja/news/blog/staff/blog/58270/':('Story','自然を守る','','#気候変動','#平和と民主主義','','news-list','Migrate'),
            'http://www.greenpeace.org/japan/ja/news/blog/staff/blog/54803/':('Story','サステナブルに生きる','','#原発','#平和と民主主義','','news-list','Migrate'),
            'http://www.greenpeace.org/japan/ja/news/blog/staff/1115-from-ae/blog/54650/':('Story','サステナブルに生きる','','#自然エネルギー','#イベント','','news-list','Migrate'),
            'http://www.greenpeace.org/japan/ja/news/blog/staff/blog/53087/':('Story','サステナブルに生きる','','#食と農業','','','news-list','Migrate'),
            'http://www.greenpeace.org/japan/ja/news/blog/staff/br/blog/50770/':('Story','サステナブルに生きる','','#原発','#ボランティア','','news-list','Migrate'),
            'http://www.greenpeace.org/japan/ja/news/blog/staff/kao/blog/49873/':('Story','自然を守る','','#森林','','','news-list','Migrate'),
            'http://www.greenpeace.org/japan/ja/library/publication/licence-to-kill/':('Publication','自然を守る','','#森林','','','article','Migrate'),
        }

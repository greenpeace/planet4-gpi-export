...
function replace_attachment($text, $attachment) {
	...
	$bodytag = str_replace($attachment, "https://storage.googleapis.com/planet4-italy-stateless-release/2018/10/". $basename , $text);
	return $bodytag;
}
...
function post_saved( $postid ) {
	...
	$local_path = 'https://release.k8s.p4.greenpeace.org/italy/wp-content/uploads/';
	$gcs_path   = 'https://storage.googleapis.com/planet4-italy-stateless-release/';

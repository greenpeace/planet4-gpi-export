...
class AllSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        start_urls = {
        'http://www.greenpeace.org/slovakia/sk/publikacie/Vysledky-testovania-jabk-oktober-2015/':('Publication','Zmeň','','Jedlo','','','article','Migrate'),
'http://www.greenpeace.org/slovakia/sk/publikacie/Vyrona-sprava---Greenpeace-Slovensko-CEE/':('Publication','Greenpeace','','ONas','','','article','Migrate'),
'http://www.greenpeace.org/slovakia/sk/publikacie/v-ro-na-sprava-2003/':('Publication','Greenpeace','','ONas','','','article','Migrate'),
'http://www.greenpeace.org/slovakia/sk/publikacie/v-ro-na-sprava-2004/':('Publication','Greenpeace','','ONas','','','article','Migrate'),
'http://www.greenpeace.org/slovakia/sk/publikacie/Skutona-cena-uhlia/':('Publication','Zmeň','','energia','KlimatickáKríza','','article','Migrate'),
'http://www.greenpeace.org/slovakia/sk/publikacie/Plan-Bee---Darujme-velam-ivot-bez-pesticidov/':('Publication','Zmeň','','Jedlo','','','article','Migrate'),
'http://www.greenpeace.org/slovakia/sk/publikacie/pcb-nebezpe-ne-dedi-stvo/':('Publication','Zmeň','','Toxic','','','article','Migrate'),
'http://www.greenpeace.org/slovakia/sk/publikacie/Horka-prichu-europskych-jabk-alebo-ako-necha-kvitnu-ekologicke-rieenia/':('Publication','Zmeň','','Jedlo','','','article','Migrate'),
'http://www.greenpeace.org/slovakia/sk/publikacie/Ekologicke-ponohospodarstvo/':('Publication','Zmeň','','Jedlo','','','article','Migrate'),
'http://www.greenpeace.org/slovakia/sk/publikacie/31-tipov-ako-setrit-energiou/':('Publication','Zmeň','','energia','KlimatickáKríza','','article','Migrate'),
'http://www.greenpeace.org/slovakia/sk/o-greenpeace/Vyrone-spravy/Vyrona-sprava-2016/':('Publication','Greenpeace','','ONas','','','article','Migrate'),
'http://www.greenpeace.org/slovakia/sk/o-greenpeace/Vyrone-spravy/Vyrocna-sprava-2013/':('Publication','Greenpeace','','ONas','','','article','Migrate'),
'http://www.greenpeace.org/slovakia/sk/o-greenpeace/Vyrone-spravy/Vyrona-sprava-2012/':('Publication','Greenpeace','','ONas','','','article','Migrate'),
'http://www.greenpeace.org/slovakia/sk/Novinky/Greenpeace-Ak-chce-vlada-ukoni-dobu-uhonu-musi-zastavi-projekt-12-aobneho-poa-v-Novakoch-/':('Story','Zmeň','','KlimatickáKríza','energia','','article','Migrate'),
'http://www.greenpeace.org/slovakia/sk/Novinky/Greenpeace-Aktivisti-a-aktivistky-su-nevinni/':('Story','Zmeň','','KlimatickáKríza','energia','','article','Migrate'),
#'http://www.greenpeace.org/slovakia/sk/Novinky/Greenpeace-Bez-noveho-receptu-pre-planetu-nepreijeme/':('Story','Zmeň','','KlimatickáKríza','','','article','Migrate'),
'http://www.greenpeace.org/slovakia/sk/Novinky/Greenpeace-blog/elektrick-i-klasick-hlavne-ich-potrebujeme-me/blog/61466/':('Story','Zmeň','','KlimatickáKríza','energia','','news-list','Migrate'),
'http://www.greenpeace.org/slovakia/sk/Novinky/U-nie-je-na-o-aka-trajkujeme-spolone-so-tudentmi/':('Press Release','Zmeň','','KlimatickáKríza','','','article','Migrate'),
'http://www.greenpeace.org/slovakia/sk/Novinky/Riaditeka-Greenpeace-Ivana-Kohutkova-odchadza-z-organizacie/':('Press Release','Zmeň','','ONas','','','article','Migrate'),
#'http://www.greenpeace.org/slovakia/sk/Novinky/Slovakia-to-quit-coal-by-2023-and-go-climate-neutral-by-2050-/':('Press Release','Zmeň','','KlimatickáKríza','energia','','article','Migrate'),
#'https://www.greenpeace.org/slovakia/sk/Novinky/Greenpeace-Uhlie-patri-do-muzea/':('Press Release','Zmeň','','KlimatickáKríza','energia','','article','Migrate'),
'http://www.greenpeace.org/slovakia/sk/Novinky/Konena-pre-uhlie-na-Hornej-Nitre-nie-je-zatia-jasna-V-aknom-plane-chyba-datum-konca-aby/':('Press Release','Zmeň','','KlimatickáKríza','energia','','article','Migrate'),
'http://www.greenpeace.org/slovakia/sk/Novinky/Greenpeace-Politicke-strany-kandidujuce-do-europarlamentu-poaduju-prisnejiu-ochranu-klimy-a-rychle-ukonenie-aby-uhlia/':('Press Release','Zmeň','','KlimatickáKríza','energia','','article','Migrate'),
'http://www.greenpeace.org/slovakia/sk/Novinky/Greenpeace-Aktivisti-a-aktivistky-su-nevinni/':('Press Release','Zmeň','','KlimatickáKríza','energia','','article','Migrate'),
'http://www.greenpeace.org/slovakia/sk/Novinky/Greenpeace-Chybajuci-datum-ukonenia-aby-uhlia-na-Slovensku-je-v-rozpore-s-europskou-legislativou/':('Press Release','Zmeň','','KlimatickáKríza','energia','','article','Migrate'),
'http://www.greenpeace.org/slovakia/sk/Novinky/Greenpeace-Buducnos-Slovenska-nie-je-v-abe-uhlia-hovoria-prezidentski-kandidati/':('Press Release','Zmeň','','KlimatickáKríza','energia','','article','Migrate'),
'http://www.greenpeace.org/slovakia/sk/Novinky/Greenpeace-blog/stle-vy-poet-ttov-e-je-proti-opakovanmu-schvl/blog/60552/':('Story','Zmeň','','Jedlo','Toxic','','news-list','Migrate'),
'http://www.greenpeace.org/slovakia/sk/Novinky/Greenpeace-blog/hurikny-povodne-a-vlny-extrmnych-teplt-prav-t/blog/60493/':('Story','Zmeň','','KlimatickáKríza','','','news-list','Migrate'),
'http://www.greenpeace.org/slovakia/sk/Novinky/Greenpeace-blog/skvel-sprva-pre-vely-lime-sa-s-fipronilom-sos/blog/60492/':('Story','Zmeň','','Jedlo','Toxic','','news-list','Migrate'),
'http://www.greenpeace.org/slovakia/sk/press/tlacove-spravy/Greenpeace-Vieme-o-si-Slovaci-myslia-o-uhli1/':('Press Release','Zmeň','','KlimatickáKríza','energia','','article','Migrate'),
'http://www.greenpeace.org/slovakia/sk/press/tlacove-spravy/Aktivisti-Greenpeace-Skonite-dobu-uhonu/':('Press Release','Zmeň','','KlimatickáKríza','energia','','article','Migrate'),
#'http://www.greenpeace.org/slovakia/sk/Novinky/Greenpeace-Slovenska-vlada-dala-na-zaiatku-prazdnin-deom-atudentom-ancu-na-lepiu-buducnos/':('Press Release','Zmeň','','KlimatickáKríza','energia','','article','Migrate'),
'http://www.greenpeace.org/slovakia/sk/Novinky/Greenpeace-Aktivisti-a-aktivistky-su-nevinni/':('Press Release','Zmeň','','KlimatickáKríza','energia','','article','Migrate'),
'http://www.greenpeace.org/slovakia/sk/press/tlacove-spravy/Greenpeace-Okolie-vypustov-banskych-vod-na-hornej-Nitre-je-zneistene-arzenom-/':('Press Release','Zmeň','','Toxic','energia','','article','Migrate'),
'http://www.greenpeace.org/slovakia/sk/Novinky/Greenpeace-Buducnos-Slovenska-nie-je-v-abe-uhlia-hovoria-prezidentski-kandidati/':('Press Release','Zmeň','','','','','article','Migrate'),
'http://www.greenpeace.org/slovakia/sk/Novinky/Greenpeace-Politicke-strany-kandidujuce-do-europarlamentu-poaduju-prisnejiu-ochranu-klimy-a-rychle-ukonenie-aby-uhlia/':('Press Release','Zmeň','','','','','article','Migrate'),
'http://www.greenpeace.org/slovakia/sk/press/tlacove-spravy/Greenpeace-Novy-navrh-VHZ-neznamena-utlm-uhlia-na-Slovensku/':('Press Release','Zmeň','','','','','article','Migrate'),
        }
    ...
    def parse_page_type2(self, response):
        ...
        if body_text:
            ...
            body_text = re.sub('<p dir="ltr">(.*)<\/p>', "\g<1>", body_text)
            if lead_text:
                body_text = '<div class="leader" style="font-weight: bold;margin-bottom: 12px">' + lead_text + '</div>' + body_text + response.xpath(' //*[@id="content"]/div[3]/div/div[2]/p').extract_first()
        ...
        try:
            ...
            date_field = date_field.replace(" di ", " ") #indonesian
            date_field = date_field.replace(" na ", " ") #slovenian
            date_field = date_field.replace(" o ", " ")  # polish #slovak
        except IndexError:
            date_field = ""
...
# Filter month name function is not needed for english speaking sites
    def filter_month_name(self, month_name):
        ...
        # Replace the slovak month name with english month name.
        for sk_month, en_month in month_sk_en.iteritems():
            month_name = month_name.replace(sk_month, en_month)

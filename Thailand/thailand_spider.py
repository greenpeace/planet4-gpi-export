...
class AllSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        #'http://www.greenpeace.org/seasia/th/press/releases/Greenpeace-SEA-Welcomes-Naderev-Yeb-Sano-as-the-New-Executive-Director/':('ข่าวประชาสัมพันธ์ (Press Release)','กรีนพีซ (Greenpeace)','','เกี่ยวกับกรีนพีซ (AboutUs)','','','article','Migrate'),
        #'http://www.greenpeace.org/seasia/th/campaigns/climate-and-energy/impacts/':('บทความ (Story)','ปกป้อง (Protect)','','สภาพภูมิอากาศ (Climate)','','','news-list','Migrate'),
        #'http://www.greenpeace.org/seasia/th/campaigns/climate-and-energy/solutions/solar/':('บทความ (Story)','เปลี่ยนแปลง (Transform)','','พลังงานหมุนเวียน (Renewable Energy)','','','news-list','Migrate'),
        ...
        'https://www.greenpeace.org/seasia/th/press/reports/Thailand-Brand-Audit-Result/':('สิ่งพิมพ์ (Publication)','ปฏิเสธ (Refuse)','','พลาสติก (Plastics)','','','article','Migrate'),
